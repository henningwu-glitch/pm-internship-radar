...
KNOWN_PM_EMPLOYERS: dict[str, list[tuple]] = {
    ...
    "Instacart Ads": [],
    # UK-native product/fintech companies — the tracker is scoped to UK
    # PM internships, and the passes above skew heavily US, so these are
    # added specifically for coverage. Guesses only; unverified ones drop
    # in Pass 3 same as everything else.
    "Revolut": [("greenhouse", "revolut")],
    "Monzo": [("greenhouse", "monzo")],
    "Wise": [("greenhouse", "wise"), ("greenhouse", "transferwise")],
    "Starling Bank": [("greenhouse", "starlingbank")],
    "GoCardless": [("greenhouse", "gocardless")],
    "Deliveroo": [("greenhouse", "deliveroo")],
    "Ocado": [("greenhouse", "ocado")],
    "Skyscanner": [("greenhouse", "skyscanner")],
    "Zopa": [("greenhouse", "zopa")],
    "Tide": [("greenhouse", "tide")],
    "Checkout.com": [("greenhouse", "checkoutcom")],
    "Trustpilot": [("greenhouse", "trustpilot")],
    ...
    "ASOS": [("smartrecruiters", "ASOS")],
    "Sage": [("workday", "sage"), ("greenhouse", "sage")],
    "BT Group": [("smartrecruiters", "BT")],
    "Sky": [("smartrecruiters", "Sky")],
    "Barclays": [("smartrecruiters", "Barclays")],
    "NatWest Group": [("smartrecruiters", "NatWestGroup")],
    "HSBC": [("smartrecruiters", "HSBC")],
    "Admiral Group": [("greenhouse", "admiralgroup")],
    "Wayve": [("greenhouse", "wayve")],
    "Featurespace": [("greenhouse", "featurespace")],
}
